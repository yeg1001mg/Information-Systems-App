...
export const SystemsTableTab: FC = () => {
    ...
    const filteredTableData = useMemo(() => {
        return (
            systemsDataSource?.filter((system) =>
                system.title.toLowerCase().includes(searchValue.toLowerCase())
            ) || []
        )
    ...
    const columns = [
        ...
        },
        {
            ...
            width: '10%',
            render: (electronicServices: number) => (
                <div style={columnWithIconStyle}>
                    <ServerIcon />
                    {electronicServices}
                    <RightArrowIcon />
