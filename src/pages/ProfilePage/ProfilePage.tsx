...
export const ProfilePage: FC = () => {
    ...
    const [generalState, setGeneralState] =
        useState<GeneralProfileState>(INITIAL_STATE)
    ...
    const isValidConformedPassword = useMemo(
        () => generalState.newPassword === generalState.conformedPassword,
        [generalState.newPassword, generalState.conformedPassword]
    )
    const isValidPhoneNumber = useMemo(
        () =>
            generalState.phoneNumber.length
                ? /^\+\d{12}$/.test(generalState.phoneNumber)
                : true,
        [generalState.phoneNumber]
    )
    const isValidForm = useMemo(
        () =>
            isValidConformedPassword &&
            isValidPhoneNumber &&
            generalState.firstName.length !== 0 &&
            generalState.secondName.length !== 0 &&
            generalState.lastName.length !== 0 &&
            generalState.identificationNumber.length !== 0,
        [isValidConformedPassword && isValidPhoneNumber, generalState]
    )
    ...
    const onSave = () => {
        ...
        if (
            generalState.newPassword.length !== 0 &&
            generalState.conformedPassword.length !== 0 &&
            isValidConformedPassword
        ) {
            dispatch(
            ...
            <div className={styles.container}>
                <div className={styles.FIO}>
                    ...
                    <div className={styles.statuses}>
                        ...
                        <div className={classNames(styles.card, styles.user)}>
                            Пользователь
                        </div>
                    </div>
                </div>
                    ...
                    <div className={styles.row}>
                        <div className={styles.column}>
                            ...
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('secondName', value)
                                }
                            />
                            <TextInput
                                readOnly
                        ...
                        <div className={styles.column}>
                            ...
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('identificationNumber', value)
                                }
                            />
                        </div>
                    </div>
                    ...
                    <div className={styles.row}>
                        ...
                        <div className={styles.column}>
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('phoneNumber', value)
                                }
                            />
                        </div>
                    </div>
                    ...
                    <div className={styles.row}>
                        ...
                        >
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('currentPassword', value)
                                }
                            />
                        </div>
                    </div>
                    <div className={styles.row}>
                        <div className={styles.column}>
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('newPassword', value)
                                }
                            />
                        </div>
                        <div className={styles.column}>
                            <TextInput
                                ...
                                onChange={(value) =>
                                    onStateUpdate('conformedPassword', value)
                                }
                                errorText={
                                    !isValidConformedPassword
                                        ? 'Пароли не совпадают'
